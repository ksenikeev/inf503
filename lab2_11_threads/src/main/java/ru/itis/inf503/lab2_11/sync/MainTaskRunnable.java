...
public class MainTaskRunnable {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread task1 = new Thread(new Task("Сообщение для потока 1", mutex));
        Thread task2 = new Thread(new Task("Сообщение для потока 2", mutex));
        Thread task3 = new Thread(new Task("Сообщение для потока 3", mutex));
